...
// The woven-heart brand mark, identical strokes to Login/About/Sidebar.
const LogoMark = ({ className }) => {
  const uid = useId();
  const gradId = `dashLogoGradient-${uid}`;
  const gradSoftId = `dashLogoGradientSoft-${uid}`;
...
// Wraps LogoMark: strokes draw in, then settle into a gentle looping
// heartbeat pulse — same rhythm as the Login page logo.
